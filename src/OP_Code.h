...
typedef struct {
    ...
    // 0 -> normal
    // 1 -> +1 cycle if page boundary is crossed
    // 2 -> +1 if branch is in same page, +2 if branch crosses page boundary
...
void opcode_matrix_example() {
    ...
    printf("Cycle modifier: %d\n", op_code_matrix[0][0].cycle_modifier);
}